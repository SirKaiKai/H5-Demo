;(function($){
	var menustr = '<a id="toTop"></a><ul id="menu"><li><a href="index4.html" id="s_home">首页</a></li><li><a href="list.html" id="cy">创业项目</a></li><li><a href="taolun.html" id="taolun">讨论</a></li><li><a href="about.html" id="about">关于我们</a></li></ul><div id="layer"></div>';
